    ...
    >
      ...
      >
        ...
        <ul>
          ...
          <li>
            Field notes about group-level activities. Resident names and medical
            records are not requested.
          </li>
          <li>
            Professor names and literature titles/URLs when you choose those
            source types.
          </li>
          <li>
            Optional environment photos. EXIF is stripped. Photos are not sent
        ...
        <h2>Research use</h2>
        <p>
          Operational records are not automatically a research dataset. Research
          use requires a separate status and review (`researchUseStatus`).
        </p>
        <h2>Retention and deletion</h2>
        <p>
          Signed-in users may export or request deletion via account API (
          <code>/api/v1/account</code>). Coordinators retain audit logs of
          submit, review, and privacy flags.
        </p>
