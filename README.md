...
with `ai.configure_workflows` can set the site default model from the direct AI
settings route. Authorized users can also select an available GPT model inside
